class createSnake {
    constructor(gameContext, gameDiv, gameBack){
      ...
      this.vel = 1;                     //eixo 'X' positivo move para direita
      this.velX = this.vel;             //recebe o deslocamento inicial 
      this.velY = 0;                    //Movimento automaticodo eixo 'Y' bloqueado no inicio
    ...
    draw(){
      ...
      for(let i = 0; i < this.snakeTrail.length; i++){
        if(i == 0){
          this.gameContext.fillStyle ='#e67e22'; //cor da cabeça
        }else{
          this.gameContext.fillStyle ='#2ecc71'; // cor da cauda
        }
  ...
  class createGameBack {
    ...
    draw(){
      ...
      //De 0px do eixo 'X' ate o maximo do canvas 400px o mesmo para o eixo 'Y'
  
      this.gameContext.fillStyle = '#fff';
      this.gameContext.font = "14px Arial";
      this.gameContext.fillText(this.score, 365, 20);
      //O score aparece ao canto direito superior
